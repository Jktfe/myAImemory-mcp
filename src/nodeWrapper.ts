...
/**
 * This is a direct Node.js wrapper for the MCP server.
 * It spawns the actual server as a child process and filters its output,
 * ensuring that only valid JSON-RPC messages are sent to stdout.
 */
